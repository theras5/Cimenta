...
// Números por defecto: 5491134249099, 57161736548553@lid y 120363420724356115@g.us
// Para múltiples números, separar con comas en la variable de entorno
const allowedNumbersEnv = process.env.ALLOWED_WHATSAPP_NUMBER || '5491134249099@s.whatsapp.net,57161736548553@lid,120363420724356115@g.us';
