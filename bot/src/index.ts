...
async function handleIncomingMessage(m: any, sock: WASocket) {
    try {
        ...
        // Ignorar mensajes del bot mismo (número 1122473956)
        const normalizedSender = normalizeJid(senderNumber);
        if (normalizedSender === '1122473956' || senderNumber.includes('1122473956')) {
            console.log(`⚠️ Mensaje del bot mismo (1122473956) ignorado: ${senderNumber}`);
            return;
        }
